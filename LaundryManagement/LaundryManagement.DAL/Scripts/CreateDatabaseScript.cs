namespace LaundryManagement.DAL.Scripts
{
    ...
    {
		public const string Content = @"USE [master]
				GO
				...
				GO
				/****** Object:  Table [dbo].[Article]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[Category]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[Color]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[Item]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[ItemStatus]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[ItemType]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[Language]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[Location]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[LocationType]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[Log]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[LogLevel]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[MovementType]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[Permission]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[PermissionFamily]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[Reception]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[ReceptionDetail]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[Roadmap]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[RoadmapReception]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[RoadmapShippings]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[RoadmapStatus]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[Shipping]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[ShippingDetail]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[ShippingStatus]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[ShippingType]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[Size]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[Tag]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[Traceability]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[Translations]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[User]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[UserHistory]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[UserPermission]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				GO
				/****** Object:  Table [dbo].[VerticalCheckDigit]    Script Date: 30/11/2022 21:48:07 ******/
				SET ANSI_NULLS ON
				GO
				SET QUOTED_IDENTIFIER ON
				GO
				...
				INSERT [dbo].[User] ([Id], [Email], [Password], [UserName], [FirstName], [LastName], [IdLanguage], [IdLocation], [CheckDigit]) VALUES (6, N'clinica@gmail.com', N'gdyb21LQTcIANtvYMT7QVQ==', N'clinica', N'Clinica', N'Usuario', 1, 4, 0x937BE1FD50BE807AB316C5FD0B6491ED)
				...
				GO
				/****** Object:  Index [IX_ShippingDetail]    Script Date: 30/11/2022 21:48:08 ******/
				...
				GO
				/****** Object:  Index [UK_Translations]    Script Date: 30/11/2022 21:48:08 ******/
